...
<div class="headNav">
  <div class="navCon w1020">
    ...
    <div class="navCon-menu fl">
      <ul>
        <li><a class="curMenu" href="/demo/type.do?type=0">商城首页</a></li>
...
<div class="remai1">
<div class="remai1_1"><a href="#"><img src="images/xinpin3.jpg" width="164" height="181" /></a></div>
...
<!--中部1结束-->
  <c:forEach items="${requestScope.typeList}" var="it"  varStatus="s">
    <c:if test="${s.count%2==1}">
    <!--中部大米开始-->
      <div class="con_dm">
<div class="con_dmbt"><span class="dt2_1"><img src="images/dm${s.count}.jpg" width="45" height="29" /></span><span class="dt2_2">${it.name}</span>
<span class="dt2_3"> <a href="tplist.html">更多商品>></a></span>
</div>
<div class="con2_dtk">
  <div class="con2_zc" id="wrap">
    <div class="wrap2">
		<ul>
            <c:forEach items="${it.goodsList}" var="it1" varStatus="s1">
              <c:if test="${s1.count==1}">
			<li>
			<h2 style="display:none"><span class="sz"><img src="images/yi${s1.count}.jpg" width="20" height="22" /></span><span class="szmc">${it1.synopsis}</span></h2>
            <a href="http://www.zhuotop.com">
            <div class="movielist" style="display:block">
            <img src="images/dy${s1.count+1}.jpg" />
            <dl>
            <dt>${it1.synopsis}</dt>
            <dd><span>价格：</span><span class="jj_y">¥${it1.price}</span></dd>
            </dl>
            </div>
            </a>
			</li>
            </c:if>
              <c:if test="${s1.count>=2 and s1.count<4}">
              <li>
                <h2><span class="sz"><img src="images/yi${s1.count}.jpg" width="20" height="22" /></span><span class="szmc">加拿大北极海参2000g/袋</span></h2>
                <a href="http://www.zhuotop.com">
                  <div class="movielist" >
...
<c:forEach items="${it.goodsList}" var="it" varStatus="s2">
    <c:if test="${s2.count>=4 and s2.count<=9}">
    <dd> <a href="#" target="_blank"> <img src="images/dm1_${s2.count-3}.jpg"  width="184" height="278">
      <div class="pictitle">
<div class="zz">
      ${it.synopsis}<br />
      <span style="color:#F00; font-size:18px;">本亲价：¥${it.price}</span>
</div>
   </div>
  ...
  <script type="text/javascript">
      window.onload=function()
      {
              ...
              var oWrap2 = document.getElementsByClassName("wrap2");
                for(var j=0;j<oWrap2.length;++j){
                        x(oWrap2[j]);
              }
          ...
          $.ajax(
              {
                  ...
                  success:function(data){
                      var html="";
                      var jsonObject=data.goodslist;
                      for(var i=0;i<jsonObject.length;i++) {
                          html += '<div class="remai1">'
                              + '<div class="remai1_1">'
                              + '<a href="cpxq.jsp"><img src="images/remai1.jpg" width="164" height="181"/></a>'
                              + '</div>'
                              + '<div class="renai1_2"><a href="#">商品名'
                              +jsonObject[i].name+'</a></div>'
                              + '<div class="renai1_3">本亲价'
                              +jsonObject[i].price+'</div></div>';
                          //alert(html);
      ...
      function sendtypeAjax() {
              ...
              function x(oWrap2) {
                  var aLi = oWrap2.getElementsByTagName('li');
                  var aH2 = oWrap2.getElementsByTagName('h2');
                  var aBox= oWrap2.getElementsByTagName('div');
    ...
    <c:if test="${s.count%2==0}">
      ...
      <div class="con_dmbt"><span class="dt2_1"><img src="images/dm2.jpg" width="45" height="29" /></span><span class="dt2_2">${it.name}</span>
        <span class="dt2_3"> <a href="#">更多商品>></a></span>
      </div>


      <div class="con2_rldk">
        <c:forEach items="${it.goodsList}" var="it8" varStatus="s8">
          <c:if test="${s8.count==1}">
        <div class="roulei_1">
          <a href="#"><img src="images/rl1.jpg" width="232" height="328" /></a>
        </div>
          </c:if>
        </c:forEach>
          <div class="roulei_2">
            <c:forEach items="${it.goodsList}" var="it9" varStatus="s9">

          <c:if test="${s9.count==2}">
          <div class="rou_gg1"><a href="#"><img src="images/rl2.jpg" width="380" height="126" /></a>
          </div>
          </c:if>
              <c:if test="${s9.count==3}">
            <div class="rou_gg1" style="padding-left:10px;"><a href="#"><img src="images/rl3.jpg" width="380" height="126"
            /></a></div>

              </c:if>
          <c:if test="${s9.count>=4 and s9.count<=7}">
          <c:if test="${s9.count==4}">
          <div class="tpl_2" style="margin-left:0px;">
            <a href="#"><div class="tpl_2bt">热推理由</div><div class="shen_jg">本亲价：¥${it9.price}</div><div class="shen_dt"><img src="images/rl4.jpg" width="180" height="114" /></div></a>
          </div>
          </c:if>
            <c:if test="${s9.count!=4}">
              <div class="tpl_2">
        ...
        <c:forEach items="${it.goodsList}" var="it7" varStatus="s7">
          <c:if test="${s7.count==8}">
          <div class="roulei_3">
          <a href="#"><img src="images/rl6.jpg" width="149" height="333" /></a>
        </div>
          </c:if>
        </c:forEach>
      </div>
