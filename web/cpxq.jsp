...
<script type="application/javascript">
  ...
  <form action="" method="post">
            <div class="xjmc_jjsm">
            <div class="cpxq_mc_1">${requestScope.feature.good.synopsis}</div>
            <div class="none" style="height:15px;"></div>
            <div class="zzl">总 重 量：500g</div>
            <div class="zzl">售     价：<span style="color:#C00; font-weight:600; font-size:18px;">￥${requestScope.feature.price}</span>  <span style="padding-left:20px;text-decoration:line-through;">市场价：￥${requestScope.feature.good.price}</span></div>
            <div class="zzl">发 货 地：${requestScope.feature.good.area}</div>
            <div class="zzl">特产属性：${requestScope.feature.reason}</div>
            ...
            <span class="jrsc_2"><a href="/demo/cart.do?type=0&gid=${requestScope.feature.good.id}"><img src="images/shoucang.jpg" width="170" height="34" /></a></span>
